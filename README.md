...
| # | File | Step | Tool | Task |
|---|------|------|------|------|
| 01 | `01-component-generation.md`         | Planning  | Claude      | Generate new HTML/CSS sections from scratch |
| 02 | `02-bug-fixing.md`                   | Any       | Claude      | Diagnose and fix layout or styling bugs |
| 03 | `03-layout-improvement.md`           | Review    | Claude      | Improve UX and visual design of a section |
| 04 | `04-responsive-fixing.md`            | Any       | Claude      | Fix mobile/tablet responsiveness |
| 05 | `gemini-prompt-services-page.md`     | Generate  | Gemini      | Build the full services.html page |
| 06 | `gemini-prompt-projects-page.md`     | Generate  | Gemini      | Build the full projects.html page |
| 07 | `antigravity-step3-integration.md`   | Integrate | Antigravity | Integrate Gemini output into the site |
| 08 | `antigravity-step4-responsiveness.md`| QA        | Antigravity | Test and fix responsiveness at all breakpoints |
...
```
1. Claude (Plan)
   └─► Write Gemini prompt using 01-component-generation.md
       or use pre-built gemini-prompt-[page].md

2. Gemini (Generate)
   └─► Paste prompt → get full HTML page output

3. Antigravity (Integrate)
   └─► antigravity-step3-integration.md
       Integrates nav/footer, fixes links, verifies in browser

4. Antigravity (QA)
   └─► antigravity-step4-responsiveness.md
       Tests 5 breakpoints, fixes issues, re-verifies

5. Claude (Review)
   └─► Paste result here → UX + layout review
